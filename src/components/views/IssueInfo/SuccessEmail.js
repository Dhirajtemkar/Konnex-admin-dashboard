      ...
      >
        <Fade in={props.delModal}>
          <div className={classes.paper}>
            <h2 id="spring-modal-title">Email Sent Successfully!</h2>
            <p id="spring-modal-description">An Email has been sent successfully containing information about the issue with id <span style={{fontWeight:"bold"}}>{props.data.tId}</span> to <span style={{fontWeight:"bold", color:"green"}}>{props.data.name}</span>.</p>
